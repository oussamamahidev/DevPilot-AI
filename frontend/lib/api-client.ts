import { API_BASE_URL, LOGIN_PATH } from "@/lib/constants";
import { getToken, removeToken } from "@/lib/auth";
import { COMMON_ERROR_MESSAGES, messageForHttpStatus } from "@/lib/errors";
...
export async function apiFetch<TResponse>(
  ...
  try {
    ...
    throw new ApiConnectionError(COMMON_ERROR_MESSAGES.backendUnreachable, error);
  }
